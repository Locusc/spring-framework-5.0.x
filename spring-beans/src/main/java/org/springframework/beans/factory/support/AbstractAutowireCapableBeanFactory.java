...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
	...
	public AbstractAutowireCapableBeanFactory() {
		super();
		// 忽略给定接口的自动装配功能
		// 当A中有属性B 那么当Spring在获取A的Bean的时候如果其属性B还没有
		// 初始化, 那么Spring会自动初始化B, 这也是Spring中提供的一个重要特性
		// 但是, 某些情况下B不会被初始化, 其中的一种情况就是B实现了BeanNameAware
		// 接口, Spring中是这样介绍的: 自动装配时忽略给定的依赖接口
		// 典型应用是通过其他方式解析Application上下文注册依赖
		// 类似于BeanFactory通过BeanFactoryAware进行注入或者
