 ...
 *
 * XmlBeanFactory对DefaultListableBeanFactor类进行了扩展
 * 主要用于从XML文档中读取BeanDefinition, 对于注册及获取bean都是使用
 * 用从父类 DefaultListableBeanFactory继承的方法去实现
...
public class XmlBeanFactory extends DefaultListableBeanFactory {
	 ...
	 * 根据给的resource创建一个新的XmlBeanFactory
